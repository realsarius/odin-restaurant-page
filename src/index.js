...
container.appendChild(gallerySlider);
...
navBarLefta.addEventListener('click', () => {
  ...
  document.getElementById(gallerySlider.id).style.display = 'none';
});
...
navBarRightUList5a.addEventListener('click', () => {
  document.getElementById(home.id).style.display = 'none';
  document.getElementById(gallery.id).style.display = 'none';
  document.getElementById(story.id).style.display = 'none';
  document.getElementById(gallerySlider.id).style.display = 'flex';
});
